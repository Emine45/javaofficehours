...
public class BmiWithPrintf {
	...
	public static void main(String[] args) {
		...
		System.out.println(name + surname + " is " + age + " years old ,his height is " + height + " and his weight is " + weight
				+ "He is" + status + " because his BMI+" + bmi);
		System.out.printf("%s %S is %d years old, his height is %.1f cm and his weight is %2f kg. He is %S because his BMI=%.1f"
				,name,surname,age,height,weight,status,bmi);
	}
