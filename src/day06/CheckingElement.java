...
public class CheckingElement {
	...
	//could you please explain briefly  why we called our method inside the if statement in first question?
		public static void main(String[] args) {
			...
			} else System.out.println("The input array does not contain " + num );
		}
			//1)create a return method
		public static boolean checkElement(int input[],int num) {
			//2)compare number with every element from array
